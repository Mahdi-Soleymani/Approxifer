...
#####################################################Approxifer########################################################################
    ...
    ####### client
            ...
            if itr==iterations-1:
                ...
                np.savetxt('K='+str(K)+'N='+str(N)+'iterations='+str(iterations)+'mode'+str(mode)+'teraficexponent'+str(background_teraffic_exponent)+'e_max'+str(e_max)+'S='+str(S)+"BATCH_stats.txt", stats)
                np.savetxt('K=' + str(K) + 'N=' + str(N) + 'iterations=' + str(iterations) +'mode'+str(mode)+ 'teraficexponent'+str(background_teraffic_exponent)+'e_max'+str(e_max)+'S='+str(S)+"BATCH_wait_times.txt", wait_times)
