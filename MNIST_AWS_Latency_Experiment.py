...
if __name__ == "__main__":
    ...
    wait_times=np.zeros([K*iterations,1], dtype=float)
...
#####################################################Approxifer########################################################################
    ...
    ####### client
            ...
            if itr==iterations-1:
                ...
                np.savetxt('K='+str(K)+'N='+str(N)+'iterations='+str(iterations)+'mode'+str(mode)+'teraficexponent'+str(background_teraffic_exponent)+"stats.txt", stats)
                np.savetxt('K=' + str(K) + 'N=' + str(N) + 'iterations=' + str(iterations) +'mode'+str(mode)+ 'teraficexponent'+str(background_teraffic_exponent)+"wait_times.txt", wait_times)
